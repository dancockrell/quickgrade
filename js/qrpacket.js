...
/* 0.64in = 16.3mm: still visually small, but large enough to survive a
 * photocopy and camera downscale. The 0.08in internal white border is about
 * four QR modules for the compact QG3 payload; the old 0.045in border was
 * only ~2 modules and jsQR became unreliable under ordinary perspective.
 * 0.20in from the physical edges stays inside common printer/copier margins. */
var QR_SIZE = 0.64, QR_INSET = 0.20, QR_QUIET = 0.08, MIN_QR_PX = 36;
